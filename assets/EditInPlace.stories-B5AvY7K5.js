import{j as t}from"./jsx-runtime-u17CrQMm.js";import{r as a}from"./iframe-B-Gjc1es.js";import"./index-CE3JwVnP.js";import{L as A,S as K,H as Q,E as $}from"./Message-Sv_P-dBu.js";import{a as B,T as G}from"./Tooltip-ClDwWj8P.js";import{S as J,V as X}from"./index-D6O2Wg94.js";import{C as Z}from"./check-B6ARIIiF.js";import{C as ee}from"./close-DLri9e1C.js";import{R as te}from"./Root-Bed3-XLq.js";import{F as ae}from"./Field-BSsgK8gQ.js";import{L as ne}from"./Label-D9rZVwmB.js";import{T as re}from"./Text-DzpzqHOZ.js";import{B as R}from"./Button-D5otGEE0.js";import"./preload-helper-PPVm8Dsz.js";import"./check-circle-solid-BPSMsxkH.js";import"./error-solid-dkbevqVi.js";import"./index-BHsbesKS.js";import"./InlineSpinner-ZvgoBa4j.js";import"./spinner-BEmPEBwE.js";import"./floating-ui.react-Dm5_JP9c.js";import"./floating-ui.react-dom-a-7ns3VL.js";import"./index-DhUufk5t.js";import"./index-rzzKfhDJ.js";import"./index-BCIL6k0e.js";import"./index-iXzKVdbG.js";import"./UnstyledButton-Cf1-ErZu.js";const se="_controls_17lij_8",E={controls:se,"button-group":"_button-group_17lij_18"};function oe(e,s){switch(s){case 0:return e===0||e===3?1:e;case 1:return 2;case 4:return 0;case 2:return e===2?3:e;case 3:return e===2?0:e;case 5:return e===3?0:e}le(s)}function le(e){throw new Error(`Unreachable value: ${e}`)}const g=a.forwardRef(function({className:s,label:o,onSave:u,onCancel:S,onInput:L,onClearServerErrors:V,serverInvalid:w,saveButtonLabel:_,cancelButtonLabel:H,savedLabel:T,savingLabel:q,helpLabel:C,disabled:k,children:F,...W},M){const[n,l]=a.useReducer(oe,0),d=a.useRef(!1),[y,p]=a.useState(!1),P=n===1||n===2||y,i=a.useRef(void 0);a.useEffect(()=>(n===3&&(i.current=setTimeout(()=>{l(5),i.current=void 0},2e3)),()=>{i.current&&clearTimeout(i.current),i.current=void 0}),[n]);const O=a.useRef(null),I=a.useRef(null),x=a.useRef(null),N=a.useCallback(()=>{d.current||(d.current=!0,p(!0))},[y,p]),D=a.useCallback(r=>{d.current&&(r.currentTarget.contains(r.relatedTarget)||(d.current=!1,p(!1)))},[y,p]),z=a.useCallback(r=>{l(0),L?.(r)},[l,L]),U=a.useCallback(async r=>{if(r.preventDefault(),n!==0)try{l(1),I.current?.blur(),await u?.(r),l(2)}catch{l(3)}},[u,n,i]),Y=a.useCallback(r=>{x.current?.blur(),S?.(r),l(4)},[x,S]);return t.jsx(te,{className:s,onSubmit:U,onReset:Y,onFocus:N,onBlur:D,onClearServerErrors:V,ref:O,children:t.jsxs(ae,{name:"input",serverInvalid:w,children:[t.jsx(ne,{children:o}),t.jsxs("div",{className:E.controls,children:[t.jsx(re,{ref:M,...W,onInput:z,disabled:k||n===2}),P&&t.jsxs("div",{className:E["button-group"],children:[t.jsx(B,{label:_,children:t.jsx(J,{asChild:!0,children:t.jsx(R,{type:"submit",kind:"primary",size:"sm",ref:I,disabled:n!==1,iconOnly:!0,Icon:Z})})}),t.jsx(B,{label:H,children:t.jsx(R,{type:"reset",kind:"secondary",size:"sm",ref:x,className:E.button,disabled:n===2,iconOnly:!0,Icon:ee})})]})]}),n===2?t.jsx(A,{children:q}):F,T&&n===3&&t.jsx(K,{children:T}),C&&(n===0||n===1)&&t.jsx(X,{children:r=>(r===void 0||r.valid)&&!w&&t.jsx(Q,{children:C})})]})})});try{g.displayName="EditInPlace",g.__docgenInfo={description:`A text box with save/cancel buttons that appear when the field is active.
Since thios control has its own 'save' button, it should *not* appear as part
of a larger form: it exists as its own form that submits separately.`,displayName:"EditInPlace",props:{label:{defaultValue:null,description:"The label for the control",name:"label",required:!0,type:{name:"string"}},disabled:{defaultValue:null,description:"If true, disabled the entire component to disallow editing.",name:"disabled",required:!1,type:{name:"boolean"}},className:{defaultValue:null,description:"The CSS class name.",name:"className",required:!1,type:{name:"string"}},onInput:{defaultValue:null,description:"onInput event handler on the text control",name:"onInput",required:!1,type:{name:"(((e: ChangeEvent<HTMLInputElement, Element>) => void) & InputEventHandler<HTMLInputElement>)"}},helpLabel:{defaultValue:null,description:"Label to be displayed under the input as a help text",name:"helpLabel",required:!1,type:{name:"string"}},serverInvalid:{defaultValue:null,description:`Whether the field is in an error state according to the server validation.
...
}`,...b.parameters?.docs?.source}}};const Fe=["Empty","WithText","Saving","WithError","WithHelpText"];export{m as Empty,v as Saving,h as WithError,b as WithHelpText,f as WithText,Fe as __namedExportsOrder,ke as default};
