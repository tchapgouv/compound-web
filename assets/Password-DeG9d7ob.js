import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r as o}from"./index-CgfFrydU.js";import{C as m}from"./index-D8_JaWTQ.js";import{a as f,V as b}from"./visibility-on-DUc8V4kF.js";import{A as h}from"./Action-BjdY7_yz.js";const r={isHidden:!0,icon:f,label:"Show",type:"password"},g={isHidden:!1,icon:b,label:"Hide",type:"text"},n=o.forwardRef(function(t,s){const[{icon:l,label:d,type:p},c]=o.useReducer(u=>u.isHidden?g:r,r);return a.jsx(h,{ref:s,...t,Icon:l,actionLabel:d,onActionClick:()=>c(),type:p})}),i=o.forwardRef(function(t,s){return a.jsx(m,{asChild:!0,children:a.jsx(n,{ref:s,...t})})});try{n.displayName="PasswordInput",n.__docgenInfo={description:`A password input with a toggle to show/hide the password.
