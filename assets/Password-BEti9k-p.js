import{j as a}from"./jsx-runtime-u17CrQMm.js";import{r as o}from"./iframe-BON6GoJJ.js";import{C as m}from"./index-C-iw2Y_R.js";import{a as f,V as b}from"./visibility-on-CaVlqnvU.js";import{A as h}from"./Action-CFVpgtmh.js";const r={isHidden:!0,icon:f,label:"Show",type:"password"},g={isHidden:!1,icon:b,label:"Hide",type:"text"},n=o.forwardRef(function(t,s){const[{icon:l,label:d,type:p},c]=o.useReducer(u=>u.isHidden?g:r,r);return a.jsx(h,{ref:s,...t,Icon:l,actionLabel:d,onActionClick:()=>c(),type:p})}),i=o.forwardRef(function(t,s){return a.jsx(m,{asChild:!0,children:a.jsx(n,{ref:s,...t})})});try{n.displayName="PasswordInput",n.__docgenInfo={description:`A password input with a toggle to show/hide the password.
